...
<body>
	...
	<center>
		<form>
			<div class="input">
				<label>Surname</label>
				<strong><?php echo $_SESSION['psurname']; ?></strong>
			</div>
			<div class="input">
				<label>Name</label>
				<strong><?php echo $_SESSION['pname']; ?></strong>
			</div>
			<div class="input">
				<label>ID Number</label>
				<strong><?php echo $_SESSION['pidnum']; ?></strong>
			</div>
			<div class="input">
				<label>Phone Number</label>
				<strong><?php echo $_SESSION['pphone']; ?></strong>
			</div>
			<div class="input">
				<label>Address</label>
				<strong><?php echo $_SESSION['paddress']; ?></strong>
			</div>
			<div class="input">
				<label>Relationship</label>
				<strong><?php echo $_SESSION['relation']; ?></strong>
			</div>
			<div class="input">
				<label>Town</label>
				<strong><?php echo $_SESSION['ptown']; ?></strong>
			</div>
		</form>
	</center>
</body>
