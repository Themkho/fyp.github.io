...
if(isset($_GET['del']))
{
    mysqli_query($bd, "delete from admin where idnum = '".$_GET['id']."'");
    $_SESSION['delmsg']="Admin record deleted!!!";
}
...
if(isset($_GET['pass']))
{
    ...
    mysqli_query($bd, "update admin set password='$newpass' where idnum = '".$_GET['id']."'");
    $_SESSION['delmsg']="Password Reset. New Password is 54321";
} 
?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                <center>
                    <div class="col-md-12">
                        <h1 class="page-head-line" style="color: navy">Registered Administrators  </h1>
                    </div>
                </center>
                </div>
                <div class="row" >
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($bd, "select * from admin order by idnum asc");
$cnt=1;
...
?>
    ...
    <tr>
        ...
        <td>											
        <a href="manage-admin.php?id=<?php echo $row['idnum']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
        <button class="btn btn-danger">Delete</button>
        </a>
        <a href="manage-admin.php?id=<?php echo $row['idnum']?>&pass=update" onClick="return confirm('Are you sure you want to reset password?')">
